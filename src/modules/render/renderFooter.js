...
export const renderFooter = () => {
  ...
  container.insertAdjacentHTML(
    ...
    <div class="footer__item footer__item_contacts footer-contacts">
      <a href="mailto:Sasha.yakimoff@gmail.com" class="footer__link">Sasha.yakimoff@gmail.com</a>
      <a href="tel:89775848397" class="footer__link">8 977 584 83 97</a>
    </div>
    ...
    <div class="footer__item footer__item_development footer-development">
      <ul class="footer-development__list">
        ...
        <li class="footer-development__item">
          Developer: <a class="footer__link" href="https://t.me/Aleksandr_Yakim">Yakimov Aleksander</a>
        </li>
      </ul>
    </div>
    `,
